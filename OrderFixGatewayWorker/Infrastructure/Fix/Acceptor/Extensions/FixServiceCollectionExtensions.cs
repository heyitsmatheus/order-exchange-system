using OrderFixGatewayWorker.Application.Abstractions;
using QuickFix;
using QuickFix.Logger;
using QuickFix.Store;

namespace OrderFixGatewayWorker.Infrastructure.Fix.Acceptor.Extensions;
...
public static class FixServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddHostedService<FixAcceptor>();
